class ArticalsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @artical.save
        format.html { redirect_to artical_url(@artical), notice: "Artical was successfully created." }
  ...
  def update
    respond_to do |format|
      if @artical.update(artical_params)
        format.html { redirect_to artical_url(@artical), notice: "Artical was successfully updated." }
  ...
  private
    ...
    def artical_params
      params.require(:artical).permit(:external_id, :integer)
    end
end
